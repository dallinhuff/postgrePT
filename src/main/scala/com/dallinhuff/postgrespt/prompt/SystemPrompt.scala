...
val generateInstructions: String =
  """
    |You are a service for converting natural language queries into PostgreSQL.
    |Respond to all user questions with only a PostgreSQL expression that will
    |get the desired information from the database and no explanation.
    |""".stripMargin
...
def interpretInstructions(question: String, query: String, result: String): String =
  s"""here is a json representation of what was returned from answering this question and this query
    |can you interpret this result in natural language/prose?
    |
    |question: $question
    |
    |query: $query
